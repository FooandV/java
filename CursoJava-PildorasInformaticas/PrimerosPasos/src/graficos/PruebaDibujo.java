...
class LaminaConFiguras extends JPanel{
	...
	protected void paintComponent(Graphics g) {
		...
		/*luego se establece el radio del circulo:Para hacer la circunferencia circunscrita al rectángulo hay que aplicar el teorema de Pitágoras para 
		 * calcular la diagonal del rectángulo, la mitad de dicha diagonal es el radio de la circunferencia,*/
		double radio = Math.hypot(rectangulo.getWidth(), rectangulo.getHeight()) / 2.;/*hypot es una función de Math que calcula la hipotenusa dados 
