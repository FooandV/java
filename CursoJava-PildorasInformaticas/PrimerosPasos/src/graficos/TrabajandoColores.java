...
class MarcoConColor extends JFrame{
	...
	public MarcoConColor() {
		...
		//Color micolor= new Color(70, 20, 50);
		//milamina.setBackground(micolor);/*poniendo colores al fondo de la lamina*/
		/*si se quiere darle color a la lamina de fondo correspondiente al color del sistema se realiza la siguiente instruccion*/
