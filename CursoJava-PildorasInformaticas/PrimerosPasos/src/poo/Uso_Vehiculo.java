...
/**
 * @author freyder
 * esta clase principal tiene dos codigos de ejemplo, uno para instanciar y realizar la ejecución
 * de codigo para la clase coche y el otro codigo2 para ejecutar y probar la clase Furgoneta
 */
public class Uso_Vehiculo {
	...
	public static void main(String[] args) {
		...
		/**
		 * @author freyder
		 * codigo para probar la clase "Coche"
		 */
		...
		*/
		...
		/**
		 * @author freyder
		 * Código para probar la clase "Furgoneta"
		 */
		
		Coche micoche1= new Coche(); //instancia de la clase Coche
		
		micoche1.setcolor("Rojo");
		
		Furgoneta mifurgoneta1= new Furgoneta(7, 580); //creando objeto furgoneta
		
		mifurgoneta1.setcolor("azul");
		mifurgoneta1.set_configura_asientos("si");
		mifurgoneta1.set_aire_acondicionado("si");
		
		System.out.println(micoche1.get_datos_generales() + " " + micoche1.getcolor());
		
		System.out.println(mifurgoneta1.get_datos_generales() + mifurgoneta1.getDatosFurgoneta()); //sacando por consola la información del hijo osea furgoneta
